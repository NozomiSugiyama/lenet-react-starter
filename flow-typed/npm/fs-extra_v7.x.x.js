...
declare module 'fs-extra' {
  ...
  declare export type CopyFilterAsync = (src: string, dest: string) => Promise<boolean>
  ...
  declare export function move(src: string, dest: string, options: MoveOptions, callback: (err: Error) => void): void
  declare export function moveSync(src: string, dest: string, options?: MoveOptions): void
  ...
  declare export function ensureDir(path: string, callback: (err: Error) => void): void
  ...
  declare export function ensureFile(path: string, callback: (err: Error) => void): void
  ...
  declare export function ensureLink(src: string, dest: string, callback: (err: Error) => void): void
  ...
  declare export function pathExists(path: string, callback: (err: Error, exists: boolean) => void): void
  declare export function pathExistsSync(path: string): boolean

  declare export function access(path: string | Buffer, callback: (err: ErrnoError) => void): void
  declare export function access(path: string | Buffer, mode: number, callback: (err: ErrnoError) => void): void
  declare export function access(path: string | Buffer, mode?: number): Promise<void>
  ...
  declare export function fchmod(fd: number, mode: string | number, callback: (err: ErrnoError) => void): void
  declare export function fchmod(fd: number, mode: string | number): Promise<void>

  declare export function fchown(fd: number, uid: number, gid: number, callback: (err: ErrnoError) => void): void
  ...
  declare export function fstat(fd: number, callback: (err: ErrnoError, stats: Stats) => any): void
  declare export function fstat(fd: number): Promise<Stats>

  declare export function fsync(fd: number, callback: (err: ErrnoError) => void): void
  declare export function fsync(fd: number): Promise<void>

  declare export function ftruncate(fd: number, callback: (err: ErrnoError) => void): void
  declare export function ftruncate(fd: number, len: number, callback: (err: ErrnoError) => void): void
  declare export function ftruncate(fd: number, len?: number): Promise<void>

  declare export function futimes(fd: number, atime: number, mtime: number, callback: (err: ErrnoError) => void): void
  declare export function futimes(fd: number, atime: Date, mtime: Date, callback: (err: ErrnoError) => void): void
  ...
  declare export function readdir(path: string | Buffer, callback: (err: ErrnoError, files: string[]) => void): void
  ...
  declare export function rmdir(path: string | Buffer, callback: (err: ErrnoError) => void): void
  declare export function rmdir(path: string | Buffer): Promise<void>

  declare export function stat(path: string | Buffer, callback: (err: ErrnoError, stats: Stats) => any): void
